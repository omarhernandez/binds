...
if (empty($_REQUEST["id"])) {
                  ...
                  $user_or_topic_data =  binds::validate_data($_REQUEST["id"],1);





                  $global_id_view = binds::getTheGlobalIdUserOrTopic($_REQUEST["id"], 1); // obetenemos el id global de relationship para saver si es persona o topico
